...
def get_callbacks(
    ...
    Args:
        ...
        saved_model_path: Directory path to save the best model
    ...
    if saved_model_path and model_name:
        checkpoint_path = os.path.join(saved_model_path, f"{model_name}_best.h5")
